...
for dir in $all_dirs;
    ...
    echo $dir;
    python ~/Research/source/mt_diffusion/average_mt_ihmt_by_angle_dti.py ../DTI_metrics/${dir}/${dir}__dti_evecs_v1.nii.gz ../DTI_metrics/${dir}/${dir}__dti_fa.nii.gz $mt_path $ihmt_path ../wm_mask/${dir}/${dir}__wm_mask.nii.gz ../FODF_metrics/${dir}/${dir}__fodf_nufo.nii.gz $output_choice;
done;

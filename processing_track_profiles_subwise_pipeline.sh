...
for bundle in $bundles;
    ...
    echo $b;
    # All scans
    in_mtr_profiles=$(for sub in $subs; do echo "${target_dir}/${sub}/track_profiles/mtr_profile_${b}.txt"; done );
    in_fixel_mtr_profiles=$(for sub in $subs; do echo "${target_dir}/${sub}/track_profiles/fixel_mtr_profile_${b}.txt"; done );
    in_nufo_profiles=$(for sub in $subs; do echo "${target_dir}/${sub}/track_profiles/nufo_profile_${b}.txt"; done );
    in_afd_profiles=$(for sub in $subs; do echo "${target_dir}/${sub}/track_profiles/afd_profile_${b}.txt"; done );
    # Only scans with rescans
    in_mtr_profiles_scan=$(for sub in $subs_scan; do echo "${target_dir}/${sub}/track_profiles/mtr_profile_${b}.txt"; done );
    in_fixel_mtr_profiles_scan=$(for sub in $subs_scan; do echo "${target_dir}/${sub}/track_profiles/fixel_mtr_profile_${b}.txt"; done );
    # in_nufo_profiles_scan=$(for sub in $subs_scan; do echo "${target_dir}/${sub}/track_profiles/nufo_profile_${b}.txt"; done );
    # in_afd_profiles_scan=$(for sub in $subs_scan; do echo "${target_dir}/${sub}/track_profiles/afd_profile_${b}.txt"; done );
    # Only rescans
    in_mtr_profiles_rescan=$(for sub in $subs_rescan; do echo "${target_dir}/${sub}/track_profiles/mtr_profile_${b}.txt"; done );
    in_fixel_mtr_profiles_rescan=$(for sub in $subs_rescan; do echo "${target_dir}/${sub}/track_profiles/fixel_mtr_profile_${b}.txt"; done );
    # in_nufo_profiles_rescan=$(for sub in $subs_rescan; do echo "${target_dir}/${sub}/track_profiles/nufo_profile_${b}.txt"; done );
    # in_afd_profiles_rescan=$(for sub in $subs_rescan; do echo "${target_dir}/${sub}/track_profiles/afd_profile_${b}.txt"; done );

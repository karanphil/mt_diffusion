...
# use : singularity exec -B /media/karp2601/T7/data/mt-diff-mcgill/ ~/Research/containers/scilus_2.0.2_from_docker.sif bash code/preprocessing_t1_mediumvox.sh
# singularity exec -B /mnt/e/data/mt-diff-mcgill/ /mnt/e/data/containers/scilus_2.0.2_from_docker.sif bash code/preprocessing_t1_mediumvox.sh

# home="/home/local/USHERBROOKE/karp2601/data/stockage";
home="/media/karp2601/T7/data";
# home="/mnt/e/data";

processed_data_dir="processed_data/preprocessing_t1_mediumvox";
cd $processed_data_dir;

b0=$home/mt-diff-mcgill/processed_data/preprocessing_dwi_mediumvox/b0_mt_off_brain.nii.gz;
fa=$home/mt-diff-mcgill/processed_data/dti_mediumvox/fa.nii.gz;
t1=$home/mt-diff-mcgill/processed_data/preprocessing_t1_mediumvox/t1_bet_nlm.nii.gz;
...
cd register_natif;
scil_volume_math.py multiplication wm_mask.nii.gz $home/mt-diff-mcgill/processed_data/preprocessing_dwi_mediumvox/b0_mt_off_brain_mask.nii.gz wm_mask.nii.gz --data_type uint16 -f;
scil_volume_math.py multiplication gm_mask.nii.gz $home/mt-diff-mcgill/processed_data/preprocessing_dwi_mediumvox/b0_mt_off_brain_mask.nii.gz gm_mask.nii.gz --data_type uint16 -f;
scil_volume_math.py multiplication csf_mask.nii.gz $home/mt-diff-mcgill/processed_data/preprocessing_dwi_mediumvox/b0_mt_off_brain_mask.nii.gz csf_mask.nii.gz --data_type uint16 -f;

...
scil_dwi_extract_b0.py dwi_mt_on_norm.nii.gz dwi_mt_on.bval dwi_mt_on.bvec mt_on_b0.nii.gz --mean --b0_threshold $b0_thr_extract_b0 --skip_b0_check;
scil_dwi_to_sh.py dwi_mt_on_norm.nii.gz dwi_mt_on.bval dwi_mt_on.bvec dwi_mt_on_sh.nii.gz --sh_order 6 --smooth 0 --mask b0_mt_off_brain_mask.nii.gz -f;
scil_sh_to_sf.py dwi_mt_on_sh.nii.gz dwi_mt_on_norm_resample.nii.gz --in_bvec dwi_mt_off.bvec --in_bval dwi_mt_off.bval --out_bval toto.bval --in_b0 mt_on_b0.nii.gz --processes 8 -f;
rm toto.bval;
scil_volume_math.py upper_clip dwi_mt_on_norm_resample.nii.gz 1 dwi_mt_on_norm_resample.nii.gz -f;
scil_volume_math.py lower_clip dwi_mt_on_norm_resample.nii.gz 0 dwi_mt_on_norm_resample.nii.gz -f;

scil_volume_math.py subtraction dwi_mt_off_norm.nii.gz dwi_mt_on_norm_resample.nii.gz dwi_MTR.nii.gz -f;

...
python ${code_dir}/python_scripts/plot_crossing_bundles_labels.py ${register_data_dir}/output/processing_registration/crossing_bundles_labels.png --in_jsons $in_jsons --bundles_names $in_bundles --nb_sections $nb_sections --save_full_txt ${register_data_dir}/output/processing_registration/crossing_bundles_labels_full.txt --save_important_txt ${register_data_dir}/output/processing_registration/crossing_bundles_labels_important.txt --important_threshold $important_threshold --min_nvox $min_nvox  -f;

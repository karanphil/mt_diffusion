...
in_bundles="AF_L AF_R CC_1 CC_2a CC_2b CC_3 CC_4 CC_5 CC_6 CC_7 CG_L CG_R CST_L CST_R MCP OR_L OR_R";
# in_bundles="AF_L AF_R CC_1 CC_2a CC_2b CC_3 CC_4 CC_5 CC_6 CC_7 CG_L CG_R CST_L CST_R ILF_L ILF_R MCP OR_L OR_R SLF_2_L SLF_2_R SLF_3_L SLF_3_R"; # Removing some bundles to simplify the plots
...
python ${code_dir}/python_scripts/plot_crossing_bundles_labels.py ${register_data_dir}/output/processing_registration/crossing_bundles_labels.png --in_jsons $in_jsons --bundles_names $in_bundles --nb_sections $nb_sections --save_full_txt ${register_data_dir}/output/processing_registration/crossing_bundles_labels_full.txt --save_important_txt ${register_data_dir}/output/processing_registration/crossing_bundles_labels_important.txt --important_threshold $important_threshold --save_crossing_txt ${register_data_dir}/output/processing_registration/crossing_bundles_labels.txt --min_nvox $min_nvox  -f;
